...
Version 0.1.0 is published as an **AI-generated proof of concept**. It was
...
The profile is approved for the bounded v0.1.0 PoC and `DEC-RELEASE` records the
owner decision for the exact release digest and canonical Pages identity.
