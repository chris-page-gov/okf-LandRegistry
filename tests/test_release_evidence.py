...
class ChecksumManifestSizePolicyTests(unittest.TestCase):
    ...
    def test_live_bundle_manifest_accepts_the_governed_artefact_sizes(
        ...
        live_jsonld_bytes = (ROOT / "bundle" / "okf-bundle.jsonld").stat().st_size
        self.assertGreater(live_jsonld_bytes, MAX_EVIDENCE_BYTES)
        self.assertLessEqual(live_jsonld_bytes, MAX_BUNDLE_ARTEFACT_BYTES)
    ...
    def test_candidate_identity_uses_the_larger_cap_only_for_bundle_artefacts(
        self,
    ) -> None:
