...
class ExplorerConsumerContractTests(unittest.TestCase):
    ...
    def test_consumer_and_harness_are_exactly_locked(self) -> None:
        ...
        self.assertEqual(consumer["release_tag"], "v0.6.1")
        self.assertEqual(consumer["version"], "0.6.1")
        self.assertEqual(
            consumer["commit_sha"],
        ...
        self.assertEqual(
            {
                ...
                "files": 16,
                "tree_sha256": (
                    "8f73184a1021f5c5654d81d0804cfafd57b35ab761979c75d9c19dce58389fa1"
                ),
                "build_manifest_sha256": (
                    "a479394534288239b98fd64423cc20a146828aeccd3284ab84984f15c57b91c7"
                ),
                "index_sha256": (
                    "8e8c95219e4d68c6dce1f384031e044fccbda9a0851f75a1d6e7c1fcc3b8e039"
                ),
            },
            build,
        )
        ...
        self.assertEqual(compatibility["minimum_version"], "0.6.1")
        self.assertEqual(compatibility["maximum_version"], "0.6.1")
    ...
    def test_acceptance_executable_materials_are_complete_and_bound(self) -> None:
        ...
        expected = {
            "runner": (
                ...
                42239,
                "0f64fc980b5a957ced3ef834719609b61ad6dbdf950fcd893e2a09e9a64aa680",
            ),
            "wrapper": (
            ...
            "contract_module": (
                ...
                17538,
                "2dbb32b1f6c4c354ef0cdf2056e2cd20c5c1ad2912563b5aa27013f3ffbb2a71",
            ),
    ...
    def test_v061_rich_runtime_limits_are_complete_and_exact(self) -> None:
        self.assertEqual(
            {
