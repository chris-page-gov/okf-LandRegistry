...
Status: **approved profile for the v0.1.1 AI-generated PoC candidate**
...
None of these prevents the clearly labelled v0.1.1 PoC. They do prevent claims
...
marked `blocking_for_build`. Publication is limited to the exact v0.1.1 digest
