...
| Change-impact classification | Complete | `validation/candidate-v0.2.0/change-impact.json` selects Land Registry G1–G9 and Stage 1 review |
...
| Independent v0.2.0 Land Registry G5 acceptance | **Blocked / not performed** | Calibration passed, but independent hard-failure and held-out review is absent |
...
No owner record approves root `e07…` after reviewing new v0.2.0 Land Registry
