...
- Status: **Stage 1 and G5 passed; exact-candidate G6 independent review,
  release recommendation, owner approval and publication remain incomplete**
...
1. obtain an independent Land Registry G6 review of the new browser,
   accessibility, security and performance evidence;
2. obtain an independent release recommendation across G1–G8;
3. assemble the exact-candidate receipts and obtain the project owner's
   Land Registry G9 approval for those exact bytes;
4. deploy one release candidate and verify its exact public identity and
   journeys; and
5. promote the same bytes without rebuilding them.

The current decision/separation-of-duties blockers are the independent G6
review, the release recommendation and the owner's G9 decision. Deterministic
source evidence for G1–G5 and G7–G8 now exists; it is deliberately not
misrepresented as the final all-gates release manifest.
...
| Exact v0.2.0 Land Registry G6 source evidence | **Independent review required** | Local Playwright/axe and 32 locked-Explorer journeys pass, but the authoring agent cannot review its own evidence |
...
| Exact v0.2.0 Land Registry G1–G8 receipts | **Not assembled** | Final assembly waits for an independent G6 pass and release recommendation |
| Independent release recommendation | **Packet ready; not yet performed** | `review/claude-release-review-v0.2.0-a3e0bdf7/` |
...
- Land Registry G6: authored-site and Explorer journeys, accessibility,
  security and performance — **independent review still required**;
...
No owner record approves root `a3e0bdf7…`. Stage 1 and Land Registry G5 are
closed, but the independent G6 review and complete release recommendation are
still outstanding. Final G1–G8 receipts therefore have not been assembled.
