...
Status: v0.1.1 AI-generated PoC release contract. The authoritative G1–G8
...
| Gate | Required evidence | Pass criterion | v0.1.1 acceptance |
|---|---|---|---|
...
The release and gate reviewer identities for v0.1.1 must be disclosed in the
...
be rerun against the v0.1.1 candidate; this is explicitly not human domain
assurance.
