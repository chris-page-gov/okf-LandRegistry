...
Both v0.3.0 manifests require the exact clean Explorer v0.6.1 checkout at
commit `839d4ba4c2d02abc6ef02b3ca1dcbf6a4008e7c8`, annotated tag object
`b5918192b1e3969ca2b069a4d56b3d26884ea96c` and immutable GitHub release
`368556872`. They bind its locked dependency tree, checkout-scoped wrapper,
...
Browser execution must use the exact locked Explorer v0.6.1 checkout and the
