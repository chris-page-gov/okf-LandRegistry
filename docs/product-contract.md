...
Status: **v0.1.1 AI-generated PoC contract; publication is exact-digest gated**
...
Version 0.1.1 was generated with AI assistance and is reviewed through
...
For v0.1.1 the owner decision can approve only the exact digest recorded in the
