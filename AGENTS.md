...
- The only admitted Reader is Explorer v0.6.1 at commit
  `839d4ba4c2d02abc6ef02b3ca1dcbf6a4008e7c8`, with the exact 16-file Bundle
  Wiki v1 profile and two-file Predicate Registry v2 extension recorded in
...
- Stage 1 authorises 22 predicate capabilities: 13 `active-emitted` and nine
  ...
  pinned Explorer v0.6.1 PWA displays those rows.
...
- Treat the class-to-route registry solely as a deterministic delivery index
  ...
  the pinned Explorer v0.6.1 PWA consumes or presents it.
