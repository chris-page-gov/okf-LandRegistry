...
- Evidence-bearing `okf:RelationshipAssertion` nodes with stable semantic
  ...
  rights metadata.
- An exact Explorer v0.6.1 consumer lock, the unchanged 16-file Bundle Wiki
  v1 semantic profile lock, and a two-file Predicate Registry v2 extension
  lock. The latter pins the 7,551-byte schema at SHA-256
